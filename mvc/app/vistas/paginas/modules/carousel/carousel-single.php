<link rel="stylesheet" type="text/css" href="<?php echo RUTA_URL; ?>/css/carousel/carousel-single/carousel-single.css">
<div>
	<div class="row row-carousel-single-title">
		<div class="container-carousel-single-title">
			<label class="label-carousel-single-title">Productos Nuevos</label>
		</div>
	</div>
	<div class="owl-carousel owl-theme" id="carousel-single">
				...
				<a href="#">
					<div id="product-card" class="">
						<div id="product-front">
							...
							<img src="http://localhost/WebPage/mvc/image/products/comida_hamster.png" alt="" style="width: 224px;height: 220px;object-fit: contain;">
							...
							<div class="stats">
								...
								<div class="stats-container">
									...
									<span class="product_name">Filtro cabeza de poder 250L</span>    
									<div class="container-btn-carousel-single">
						...
						<div id="product-back">
							...
							<div id="carousel">
								...
								<div class="arrows-perspective">
									<div class="carouselPrev visible">
										<div class="y"></div>
										<div class="x"></div>
									</div>
									<div class="carouselNext visible">
										<div class="y"></div>
										<div class="x"></div>
									</div>
								</div>
			...
			<div id="make-3D-space">
				<a href="#">
					<div id="product-card" class="">
						<div id="product-front">
							<div class="shadow"></div>
							<img src="http://localhost/WebPage/mvc/image/products/comida_hamster_2.png" alt="" style="width: 224px;height: 220px;object-fit: contain;">
							<div class="image_overlay"></div>
							<!--<div id="view_details">View details</div>-->
							<div class="stats">
								<div class="container-btns-mobil" style="position: absolute;justify-content: right;text-align: right;top: 177px;background: #ffffff00;padding: 5px;width: 100%;">
			...
			<div id="make-3D-space">
				<a href="#">
					<div id="product-card" class="">
						<div id="product-front">
							<div class="shadow"></div>
							<img src="http://localhost/WebPage/mvc/image/products/pecera_panoramica_20cm.png" alt="" style="width: 224px;height: 220px;object-fit: contain;">
							<div class="image_overlay"></div>
							<!--<div id="view_details">View details</div>-->
							<div class="stats">
								<div class="container-btns-mobil" style="position: absolute;justify-content: right;text-align: right;top: 177px;background: #ffffff00;padding: 5px;width: 100%;">
			...
			<div id="make-3D-space">
				<a href="#">
					<div id="product-card" class="">
						<div id="product-front">
							<div class="shadow"></div>
							<img src="http://localhost/WebPage/mvc/image/products/pecera_panoramica_20cm_2.png" alt="" style="width: 224px;height: 220px;object-fit: contain;">
							<div class="image_overlay"></div>
							<!--<div id="view_details">View details</div>-->
							<div class="stats">
								<div class="container-btns-mobil" style="position: absolute;justify-content: right;text-align: right;top: 177px;background: #ffffff00;padding: 5px;width: 100%;">
			...
			<div id="make-3D-space">
				<a href="#">
					<div id="product-card" class="">
						<div id="product-front">
							<div class="shadow"></div>
							<img src="http://localhost/WebPage/mvc/image/products/producto.jpg" alt="" style="width: 224px;height: 220px;object-fit: contain;">
							<div class="image_overlay"></div>
							<!--<div id="view_details">View details</div>-->
							<div class="stats">
								<div class="container-btns-mobil" style="position: absolute;justify-content: right;text-align: right;top: 177px;background: #ffffff00;padding: 5px;width: 100%;">
...
<script type="text/javascript" src="<?php echo RUTA_URL;?>/js/carousel/carousel-single/carousel-single.js"></script>

...
<div>
	<div class="owl-carousel owl-theme" id="carousel-single">
	    <!--<div class="item item-product">
			<div class="container-item-product">
				<div class="image-item-single">
					<img src="image/products/producto.jpg" style="width: 224px;height: 224px;object-fit: contain;">
				</div>
				<div class="container-description-single">
					<div class="description-item-single">
						Filtro cabeza de poder 250L
					</div>
	    ...
	    <div class="item item-product">
			<div class="container-item-product">
				<div class="image-item-single">
					<img src="image/products/filtro.jpg" style="width: 224px;height: 224px;object-fit: contain;">
				</div>
				<div class="container-description-single">

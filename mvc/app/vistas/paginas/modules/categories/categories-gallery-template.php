<div class="wrapper">
	...
	<main class="content">
		<div class="feed-grid">
			<div class="card-half wide">
				...
				<ul class="card-tools">
					<li class="tools-item">
						...
						<span class="tools-count">543</span>
					</li>
					<li class="tools-item">
			...
			<div class="card"> 
				<img src="https://40.media.tumblr.com/027d3fdde45d8cb950a74dd070cf8e90/tumblr_nxfo8rG3o81qzleu4_og_540.jpg" alt="img">
			...
			<div class="card-half wide">
				<div class="card-img">
					<img src="https://40.media.tumblr.com/tumblr_lzgmkfRJ7U1qb899go1_500.jpg" alt="img">
				</div>
				<div class="card-text">
				...
				<ul class="card-tools">
					<li class="tools-item">
						...
						<span class="tools-count">133</span>
					</li>
					<li class="tools-item">
			...
			<div class="card-half">
				...
				<ul class="card-tools">
					<li class="tools-item">
						<i class="fa fa-heart like"></i>
						<span class="tools-count">4533</span>
					</li>
					<li class="tools-item">
						<i class="fa fa-share share"></i>
					</li>
			...
			<div class="card"> 
				<img src="https://41.media.tumblr.com/7be0a9c6035a5eaaafaddab95a3d77ae/tumblr_mmp17zInpt1qhfgjbo1_540.jpg" alt="img">
				<div class="info-center">Best 100 memorable sports photos</div>
			</div>
			<div class="card">
				<img src="https://cdn-images-1.medium.com/max/600/1*wFiuAFruqIUTNU99xpb_zw.gif" alt="img">
			...
			<div class="card">
				<img src="https://40.media.tumblr.com/214255d33d16e6075d674c9cd84d9a6c/tumblr_no7630It9v1qd6rjmo1_540.jpg" alt="img">
			...
			<div class="card-half">
				<div class="card-img">
					...
					<img src="https://40.media.tumblr.com/682b6eb0bcafb090c26cda164a235f3b/tumblr_n04czvggDF1sv6eyto1_500.jpg" alt="img">
				</div>
				<div class="card-text">
				...
				<ul class="card-tools">
					<li class="tools-item">
						<i class="fa fa-heart like"></i>
						<span class="tools-count">8543</span>
					</li>
					<li class="tools-item">
						<i class="fa fa-share share"></i>
					</li>
